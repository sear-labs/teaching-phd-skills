...
artifact: **A text-box entry**: the magnitude you predicted before running, the actual, a unit audit of every input and output, one published reference value with its source, and one extreme case
---
...
- **You hand in:** **A text-box entry**: the magnitude you predicted before running, the actual, a unit audit of every input and output, one published reference value with its source, and one extreme case
